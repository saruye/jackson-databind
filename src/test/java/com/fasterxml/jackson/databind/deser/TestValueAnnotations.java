...
//jackson-databind/build/j2objcSrcGenTest/com/fasterxml/jackson/databind/deser/TestValueAnnotations.m:555:126: error: implicit declaration of function 'IOSObjectArray_class_' is invalid in C99 [-Werror,-Wimplicit-function-declaration]
//        return [IOSObjectArray arrayWithObjects:(id[]) { [[[ComFasterxmlJacksonDatabindAnnotationJsonDeserialize alloc] initWithAs:IOSObjectArray_class_() withBuilder:JavaLangVoid_class_() withContentAs:JavaLangVoid_class_() withContentConverter:ComFasterxmlJacksonDatabindUtilConverter_None_class_() withContentUsing:ComFasterxmlJacksonDatabindJsonDeserializer_None_class_() withConverter:ComFasterxmlJacksonDatabindUtilConverter_None_class_() withKeyAs:JavaLangVoid_class_() withKeyUsing:ComFasterxmlJacksonDatabindKeyDeserializer_None_class_() withUsing__:ComFasterxmlJacksonDatabindJsonDeserializer_None_class_()] autorelease] } count:1 type:JavaLangAnnotationAnnotation_class_()];
//        ^
//       jackson-databind/build/j2objcSrcGenTest/com/fasterxml/jackson/databind/deser/TestValueAnnotations.m:555:126: error: incompatible integer to pointer conversion sending 'int' to parameter of type 'IOSClass *' [-Werror,-Wint-conversion]
//        return [IOSObjectArray arrayWithObjects:(id[]) { [[[ComFasterxmlJacksonDatabindAnnotationJsonDeserialize alloc] initWithAs:IOSObjectArray_class_() withBuilder:JavaLangVoid_class_() withContentAs:JavaLangVoid_class_() withContentConverter:ComFasterxmlJacksonDatabindUtilConverter_None_class_() withContentUsing:ComFasterxmlJacksonDatabindJsonDeserializer_None_class_() withConverter:ComFasterxmlJacksonDatabindUtilConverter_None_class_() withKeyAs:JavaLangVoid_class_() withKeyUsing:ComFasterxmlJacksonDatabindKeyDeserializer_None_class_() withUsing__:ComFasterxmlJacksonDatabindJsonDeserializer_None_class_()] autorelease] } count:1 type:JavaLangAnnotationAnnotation_class_()];
